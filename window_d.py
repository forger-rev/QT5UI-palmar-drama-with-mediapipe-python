...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBoxLog.setGeometry(QtCore.QRect(540, 20, 410, 370))
        ...
        self.textLog.setGeometry(QtCore.QRect(10, 20, 390, 340))
        self.textLog.setObjectName("textLog")
        self.groupBoxResult = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBoxResult.setGeometry(QtCore.QRect(10, 20, 520, 370))
        ...
        self.labelResult.setGeometry(QtCore.QRect(10, 20, 500, 340))
        ...
        self.menuTrainingOption = QtWidgets.QMenu(self.menubar)
        self.menuTrainingOption.setObjectName("menuTrainingOption")
        self.menuSettings = QtWidgets.QMenu(self.menubar)
        self.menuSettings.setObjectName("menuSettings")

        self.menuLoadModelFile = QtWidgets.QMenu(self.menuTrainingOption)
        self.menuLoadModelFile.setObjectName("menuLoadModelFile")
        ...
        self.actionLoadT_Me = QtWidgets.QAction(MainWindow)
        self.actionLoadT_Me.setObjectName("actionLoadT_Me")
        self.actionLoadT_You = QtWidgets.QAction(MainWindow)
        self.actionLoadT_You.setObjectName("actionLoadT_You")
        self.actionLoadT_Third = QtWidgets.QAction(MainWindow)
        self.actionLoadT_Third.setObjectName("actionLoadT_Third")
        self.actionLoadT_Head = QtWidgets.QAction(MainWindow)
        self.actionLoadT_Head.setObjectName("actionLoadT_Head")
        self.actionLoadT_Side = QtWidgets.QAction(MainWindow)
        self.actionLoadT_Side.setObjectName("actionLoadT_Side")
        self.actionLoadT_Full = QtWidgets.QAction(MainWindow)
        self.actionLoadT_Full.setObjectName("actionLoadT_Full")
        ...
        self.menuLoadModelFile.addAction(self.actionLoadT_Me)
        self.menuLoadModelFile.addAction(self.actionLoadT_You)
        self.menuLoadModelFile.addAction(self.actionLoadT_Third)
        self.menuLoadModelFile.addAction(self.actionLoadT_Head)
        self.menuLoadModelFile.addAction(self.actionLoadT_Side)
        self.menuLoadModelFile.addAction(self.actionLoadT_Full)

        self.menuFile.addAction(self.menuLoadLocalFile.menuAction())
        self.menuFile.addSeparator()

        self.menuTrainingOption.addAction(self.menuLoadModelFile.menuAction())
        self.menuTrainingOption.addSeparator()

        self.menuFile.addAction(self.actionExit)
        self.menuCamera.addAction(self.actionOpenCamera)
        self.menuCamera.addAction(self.actionCloseCamera)
        # self.menuParameters.addAction(self.actionHandSize)
        self.menuParameters.addAction(self.actionMinDetectionConfidence)
        self.menuParameters.addAction(self.actionMinTrackingConfidence)
        # self.menuParameters.addAction(self.actionModelFile)
        self.menuTrainingOption.addAction(self.actionStart)
        self.menuTrainingOption.addAction(self.actionPredict)
        ...
        self.menubar.addAction(self.menuTrainingOption.menuAction())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menuTrainingOption.setTitle(_translate("MainWindow", "Training_Option"))
        ...
        self.menuLoadModelFile.setTitle(_translate("MainWindow", "Change_Model_File"))
        self.actionLoadT_Me.setText(_translate("MainWindow", "Training_我"))
        self.actionLoadT_You.setText(_translate("MainWindow", "Training_你"))
        self.actionLoadT_Third.setText(_translate("MainWindow", "Training_他"))
        self.actionLoadT_Head.setText(_translate("MainWindow", "Training_晃頭"))
        self.actionLoadT_Side.setText(_translate("MainWindow", "Training_旁支"))
        self.actionLoadT_Full.setText(_translate("MainWindow", "Training_全動作"))
        ...
        self.actionPredict.setText(_translate("MainWindow", "Start_Training"))
